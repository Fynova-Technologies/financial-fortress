    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black/80 p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="mb-6">
            Your email has been verified. Click below to log in and continue.
          </p>
          <button
            onClick={handleLogin}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black/80 p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="mb-4">
            We couldn't confirm your email verification yet. Please wait a
            moment and try again, or sign in manually.
          </p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black/80 p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="mb-4">
            We couldn't find the verification information in the URL. Please
            sign in and we'll detect your verified status.
          </p>
          <button
            onClick={handleLogin}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black/80 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
        ...
        <p className="mb-4">
          There was an error checking verification status: {errorMsg}
        </p>
        <div className="flex justify-center gap-3">
          <button
            onClick={() => window.location.reload()}
