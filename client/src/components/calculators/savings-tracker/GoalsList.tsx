...
// export default function GoalsList({ savingsData, results, onEdit, onDelete, onContribute, isDeleting }: Props) {
//   return (
//     <Card className="bg-white dark:bg-gray-800 shadow-md">
//       <CardContent className="p-6">
//         <div className="flex justify-between items-center mb-4">
//           <h3 className="text-lg font-semibold">Track Goals</h3>
//           <Button onClick={() => onEdit(null as any)} size="sm">Add Goal</Button>
//         </div>
  ...
  return (
    <Card className="bg-white dark:bg-gray-800 shadow-md">
      <CardContent className="p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold">Track Goals</h3>
          <Button onClick={() => onEdit(null)} size="sm">Add Goal</Button>
        </div>
