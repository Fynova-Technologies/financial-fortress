...
// interface SalaryManagementRequest
...
// interface SavingsGoalArrayRequest
...
//           await storage.getMortgageCalculationsByUserId(user.id);
...
//       const { loanAmount, interestRate, loanTerm, termType, startDate } =
//         req.body;
...
//     checkJwt,
//     async (req: RetirementRequest, res) => {
//       try {
//         const auth0_id = req.auth?.sub;
//         console.log("Auth0 ID:", auth0_id);
//         if (!auth0_id) {
...
//           await storage.getRetirementCalculationsByUserId(user.id);
...
//     checkJwt,
//     async (req: SalaryManagementRequest, res) => {
//       try {
//         const auth0_id = req.auth?.sub;
//         console.log("Auth0 ID:", auth0_id);
//         if (!auth0_id) {
...
//         const salaryManagement = await storage.getSalaryManagementByUserId(
//           user.id
//         );
...
//     "/api/savings-goals",
//     checkJwt,
//     async (req: SavingsGoalArrayRequest, res) => {
//       try {
//         const auth0_id = req.auth?.sub;
//         console.log("Auth0 ID:", auth0_id);
...
//         return res
//           .status(500)
//           .json({ error: "Failed to get management token" });
